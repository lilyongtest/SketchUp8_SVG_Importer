...
1. メニューの **[Plugins] > [Import SVG (Stable)]** をクリックします。
 <img width="425" height="309" alt="image" src="https://github.com/user-attachments/assets/4f45e5c1-1095-439c-8d61-563eedb85dda" />

2. インポートしたい `.svg` ファイルを選択します。
3. 自動的に座標が計算され、モデル上にエッジおよび曲線が生成されます。
<img width="528" height="357" alt="image" src="https://github.com/user-attachments/assets/7b55f76f-2071-440f-8405-459884ac2422" />
...
* **その他**: 
　これは個人的に必要だったので作成したものですので、完璧ではありません。元のSVGファイルの状態によっては期待する結果にならないことが多いのであくまで実験的に使用をよろしくお願いいたします
